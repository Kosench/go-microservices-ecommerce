...
// PaymentMethod определяет доступные способы оплаты в системе.
...
// PayOrderRequest содержит данные для обработки платежа за заказ.
...
// PayOrderResponse возвращает идентификатор транзакции после успешной оплаты.
...
func (x *PayOrderResponse) GetTransaction() string {
	if x != nil {
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\x0epayment_method\x18\x03 \x01(\x0e2\x19.payment.v1.PaymentMethodR\rpaymentMethod\"4\n" +
	"\x10PayOrderResponse\x12 \n" +
	"\vtransaction\x18\x01 \x01(\tR\vtransaction*\xa3\x01\n" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseB\xbc\x01\n" +
	"\x0ecom.payment.v1B\fPaymentProtoP\x01ZSgithub.com/Kosench/go-microservices-ecommerce/shared/pkg/proto/payment/v1;paymentv1\xa2\x02\x03PXX\xaa\x02\n" +
	"Payment.V1\xca\x02\n" +
