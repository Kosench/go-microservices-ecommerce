...
func encodeCancelOrderByUuidResponse(response CancelOrderByUuidRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *ComponentsErrorsUnauthorizedError:
	...
	case *ComponentsErrorsForbiddenError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(403)
	...
	case *ComponentsErrorsNotFoundError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(404)
	...
	case *ComponentsErrorsConflictError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(409)
	...
	case *ComponentsErrorsRateLimitError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(429)
	...
	case *ComponentsErrorsBadGatewayError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(502)
	...
	case *ComponentsErrorsServiceUnavailableError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(503)
	...
	case *ComponentsErrorsGenericErrorStatusCode:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
...
func encodeCreateOrderResponse(response CreateOrderRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *ComponentsCreateOrderResponse:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
	...
	case *ComponentsErrorsBadRequestError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(400)
	...
	case *ComponentsErrorsValidationError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(422)
	...
	case *ComponentsErrorsInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
...
func encodeGetOrderByUuidResponse(response GetOrderByUuidRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *ComponentsGetOrderResponse:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodePayOrderResponse(response PayOrderRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *ComponentsPayOrderResponse:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
