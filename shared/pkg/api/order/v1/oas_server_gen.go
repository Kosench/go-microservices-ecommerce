...
type Handler interface {
	...
	//
	// POST /api/v1/orders
	CreateOrder(ctx context.Context, req *ComponentsCreateOrderRequest, params CreateOrderParams) (CreateOrderRes, error)
	...
	PayOrder(ctx context.Context, req *ComponentsPayOrderRequest, params PayOrderParams) (PayOrderRes, error)
}
